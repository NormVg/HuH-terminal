...
const vercel_theme = {
  ...
  const clipboardAddon = new ClipboardAddon({
  // Using the browser's native clipboard API
  // You can provide custom functions for copy/paste if needed
  ...
  console.log(terminal)
    const adjustSize = () => {
      ...
      // resizePty(cols, rows);
      window.electron.ipcRenderer.send("terminal-resize", {"row":rows,"col":cols});
